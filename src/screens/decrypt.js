    ...
    return (
        <React.Fragment>
            <div className="my-4">
                ...
                <input type="text" className="w-full md:w-1/2 bg-slate-600 rounded-md outline-none px-2 py-2 text-white focus:ring-2 focus:ring-slate-500" onChange={(evt) => handleCypherTextChange(evt)} />
            </div>
            <div className="my-4">
