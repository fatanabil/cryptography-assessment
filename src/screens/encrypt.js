    ...
    return (
        <React.Fragment>
            <div className="my-4">
                ...
                <input type="text" className="w-1/2 bg-slate-600 rounded-md outline-none px-2 py-2 text-white focus:ring-2 focus:ring-slate-500" onChange={(evt) => handleTextChange(evt)} />
            </div>
            <div className="my-4">
                ...
                <button className="px-4 py-2 text-white bg-slate-600 rounded-md ml-4 hover:bg-slate-700 transition-all duration-300" onClick={generateKey}>Generate Key</button>
            </div>
